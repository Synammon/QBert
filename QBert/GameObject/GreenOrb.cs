...
namespace QBert.GameObject
{
    public class GreenOrb : Sprite
    {
        ...
        public GreenOrb(Game game, SpriteBatch spriteBatch)
        ...
        public override void Initialize()
        {
            _moving = true;
            base.Initialize();
            // Additional initialization logic for GreenOrb
        }

        protected override void LoadContent()
        {
            base.LoadContent();
            _texture = Game.Content.Load<Texture2D>("GreenSphere");
